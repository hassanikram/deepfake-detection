...
def main():
    ...
    for dataset in test_sets:
        if dataset.split('-')[0] == 'celeb' and (celeb_df_path is None or celeb_faces_dir is None):
            raise RuntimeError('Specify DataFrame and directory for celeb faces for testing!')
    splits = split.make_splits(celeb_df=celeb_df_path, celeb_dir=celeb_faces_dir,
